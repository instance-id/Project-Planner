...
| "instance.id.projectplanner":"https://github.com/instance-id/Project-Planner.git?path=Assets/Project Planner", |   
| "instance.id.projectplanner":"https://github.com/instance-id/Project-Planner.git#upm",|   
